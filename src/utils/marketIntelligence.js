// Utility function to analyze trade history, candle volatility, and determine best trading hours and days
...
export function analyzeMarketConditions({ dbTrades = [], candles = [], currentSymbol = '' }) {
  ...
  if (currentHourStats.total >= 3) {
    ...
    if (currentHour >= 8 && currentHour <= 12) {
      ...
      statusBadge = '🔴 ATENÇÃO / ALTO RISCO';
      statusColor = '#ef4444';
      statusBg = 'rgba(239, 68, 68, 0.15)';
      statusBorder = 'rgba(239, 68, 68, 0.4)';
    } else {
