...
export const formatWinMessage = (profit, balance, dailyGoalPercent = 0) => {
  return `🟢 <b>WIN! OPERAÇÃO VITORIOSA</b>\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         `<b>Lucro:</b> <code>+$${parseFloat(profit).toFixed(2)}</code>\n` +
         `<b>Saldo Atual:</b> <code>$${parseFloat(balance).toFixed(2)}</code>\n` +
         `<b>Progresso Meta Diária:</b> <code>${dailyGoalPercent.toFixed(1)}%</code>\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         `🤖 <i>ASTROBOT operando em modo automático.</i>`;
};
...
export const formatLossMessage = (loss, balance, nextGaleLevel = 0, nextStake = 0) => {
  ...
  return `🔴 <b>LOSS! OPERAÇÃO CONCLUÍDA</b>\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         `<b>Prejuízo:</b> <code>-$${Math.abs(parseFloat(loss)).toFixed(2)}</code>\n` +
         `<b>Saldo Atual:</b> <code>$${parseFloat(balance).toFixed(2)}</code>` +
         galeSection +
         `\n━━━━━━━━━━━━━━━━━━━━━━\n` +
         `⚠️ <i>Mantenha a calma e siga seu gerenciamento de risco.</i>`;
};
...
export const formatOpportunityFound = (symbol, strategy, direction, winRate, stake, time) => {
  ...
  return `🚨 <b>OPORTUNIDADE ENCONTRADA</b>\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         ...
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         `🧠 <i>IA ASTROBOT calculando entrada na próxima vela.</i>`;
};
...
export const formatStatusReport = (isRunning, settings, balance, sessionStats = {}) => {
  ...
  const statusText = isRunning ? 'BOT OPERANDO' : 'ROBÔ PAUSADO';
  ...
  return `${statusEmoji} <b>STATUS DO ASTROBOT</b>\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         `<b>Estado:</b> <code>${statusText}</code>\n` +
         `<b>Saldo Atual:</b> <code>$${parseFloat(balance).toFixed(2)}</code>\n` +
         `<b>Lucro Sessão:</b> <code>${profitSign}$${parseFloat(profit).toFixed(2)}</code>\n` +
         `<b>Placar Sessão:</b> <code>${wins}W - ${losses}L</code> (Winrate: <code>${winrate.toFixed(1)}%</code>)\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         `<b>Ativo:</b> <code>${settings.symbol}</code>\n` +
         `<b>Timeframe:</b> <code>M${settings.granularity === '60' ? '1' : settings.granularity === '300' ? '5' : '15'}</code>\n` +
         `<b>Gerenciamento:</b> <code>${settings.moneyManagement.toUpperCase()}</code>\n` +
         `<b>Piloto Automático:</b> <code>${settings.autoPilot ? 'ATIVADO' : 'DESATIVADO'}</code>\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
...
export const formatDailySummary = (stats) => {
  ...
  return `📊 <b>RESUMO DIÁRIO - ASTROBOT</b>\n` +
         `━━━━━━━━━━━━━━━━━━━━━━\n` +
         ...
         `<b>Total Operações:</b> <code>${stats.total || 0}</code>\n` +
         `<b>Wins / Losses:</b> <code>${stats.wins || 0}W - ${stats.losses || 0}L</code>\n` +
         ...
         `<b>Maior Sequência Positiva:</b> <code>${stats.maxStreak || 0} wins</code>\n` +
