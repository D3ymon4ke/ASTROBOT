...
// Format Win message
export { formatWinMessage, formatLossMessage, formatOpportunityFound, formatOrderExecuted, formatTakeProfitMessage, formatStopLossMessage } from '../../vps-backend/utils/telegramTemplates.js';
