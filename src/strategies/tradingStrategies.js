...
export function analyzeStrategies(candles, maxMartingale = 0) {
  ...
  const rawList = [
    ...
    },
    {
      ...
      totalTrades: fakegaleResult.totalTrades,
      wins: fakegaleResult.wins,
      losses: fakegaleResult.losses,
      description: 'Estratégia MHI com filtro Fakegale. A 1ª vela serve de sinal virtual; a entrada real com stake inicial ocorre na 2ª vela (G1) após loss virtual, seguido de martingales normais.'
    },
    {
      id: 'mhi_auto',
