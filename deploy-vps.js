...
const FILES_TO_UPLOAD = [
  ...
  { local: 'vps-backend/automation/FakegaleTrader.js', remote: '/root/astrobot-backend/automation/FakegaleTrader.js' },
  { local: 'vps-backend/automation/DigitTrader.js', remote: '/root/astrobot-backend/automation/DigitTrader.js' },
  { local: 'vps-backend/automation/digitAnomaly.js', remote: '/root/astrobot-backend/automation/digitAnomaly.js' },
  ...
  { local: 'vps-backend/automation/ResearchRecorder.js', remote: '/root/astrobot-backend/automation/ResearchRecorder.js' },
  { local: 'vps-backend/automation/tickReplay.js', remote: '/root/astrobot-backend/automation/tickReplay.js' },
  { local: 'vps-backend/automation/breakout.js', remote: '/root/astrobot-backend/automation/breakout.js' },
  { local: 'vps-backend/automation/directionBenchmark.js', remote: '/root/astrobot-backend/automation/directionBenchmark.js' },
  { local: 'vps-backend/automation/pullbackStudy.js', remote: '/root/astrobot-backend/automation/pullbackStudy.js' },
  ...
  { local: 'vps-backend/utils/telegramTemplates.js', remote: '/root/astrobot-backend/utils/telegramTemplates.js' },
